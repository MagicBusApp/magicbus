...
import com.magicbusapp.magicbus.MainActivity;
...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
    ...
    public FirebaseListAdapter(Query mRef, Class<T> mModelClass, int mLayout, final Activity activity) {
        ...
        mListener = this.mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                MessageChat m = (MessageChat) model;

                Location locationMessage = new Location("");
                locationMessage.setLatitude(m.getLatitude());
                locationMessage.setLongitude(m.getLongitude());

                Location myLocation = ((MainActivity) activity).getCurrentLocation();
                float distanza = myLocation.distanceTo(locationMessage);

                if (m.getNickname().equalsIgnoreCase("MagicBus Team") || distanza <= MBApplication.getDistanzaMetriChat()) {
     ...
     */
    protected abstract void populateView(View v, T model, String nickname);
}